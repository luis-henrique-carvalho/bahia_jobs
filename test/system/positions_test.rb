...
class PositionsTest < ApplicationSystemTestCase
  ...
  test "should create position" do
    ...
    fill_in "Career", with: @position.career
    fill_in "City", with: @position.city
    fill_in "Company", with: @position.company_id
    fill_in "Contract", with: @position.contract
    fill_in "Description", with: @position.description
    fill_in "Name", with: @position.name
    check "Publish" if @position.publish
    check "Remote" if @position.remote
    fill_in "State", with: @position.state
    fill_in "Summary", with: @position.summary
